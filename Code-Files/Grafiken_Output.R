...
png(file="Grafiken/test.png", width=1000, height=400)
motivplot
dev.off()
...
# copy all graphs to delivery folder
flist <- list.files("Grafiken", full.names = TRUE)
file.copy(flist, "../Fertige_Grafiken")
